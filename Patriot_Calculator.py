...
# Бесконечный цикл
while True:
    one = int(input(f"{Fore.LIGHTWHITE_EX}Введи число: "))  # Спрашиваем первое число
    operation = input(f"{Fore.LIGHTBLUE_EX}Что Делаем? (+, -, *, /, %, !, **(степень), √): ") # Спрашиваем пользователя операцию
